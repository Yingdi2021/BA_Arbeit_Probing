        ...
        for BminusA in R1:
            ...
            for i in R2:
                ...
                if scenario == Scenario.NONE:
                    utility_a = myUtilityForExactXCases(inputData, 0, A)
                    utility_ai = myUtilityForExactXCases(inputData, 0, ai)
                    utility_b = myUtilityForExactXCases(inputData, 0, B)
                    utility_bi = myUtilityForExactXCases(inputData, 0, bi)
                elif scenario == Scenario.EXACT1:
                    utility_a = myUtilityForExactXCases(inputData, 1, A)
                    utility_ai = myUtilityForExactXCases(inputData, 1, ai)
                    utility_b = myUtilityForExactXCases(inputData, 1, B)
                    utility_bi = myUtilityForExactXCases(inputData, 1, bi)
                elif scenario == Scenario.ALL:
                    utility_a = myUtilityForExactXCases(inputData, n, A)
                    utility_ai = myUtilityForExactXCases(inputData, n, ai)
                    utility_b = myUtilityForExactXCases(inputData, n, B)
                    utility_bi = myUtilityForExactXCases(inputData, n, bi)
                elif scenario == Scenario.NONEORALL:
                    utility_a = myUtilityForXorYcases_silent(inputData, 0, n, A)
                    utility_ai = myUtilityForXorYcases_silent(inputData, 0, n, ai)
                    utility_b = myUtilityForXorYcases_silent(inputData, 0, n, B)
                    utility_bi = myUtilityForXorYcases_silent(inputData, 0, n, bi)
